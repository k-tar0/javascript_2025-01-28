import { tableMake, tableMake19} from "./tablemakingJS.js";
...
document.getElementById("table18:00").addEventListener('click', () => tableMake(floorNames, wingNames, allRoomsAndTime));
document.getElementById("table19:00").addEventListener('click', () => tableMake19(floorNames, wingNames, allRoomsAndTime));
